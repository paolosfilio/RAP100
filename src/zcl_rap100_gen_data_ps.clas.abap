CLASS zcl_rap100_gen_data_PS DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_PS IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'PS',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravPS.
*    DELETE FROM zrap100_dtravPS.

    "insert travel demo data
    INSERT zrap100_atravPS  FROM (
        SELECT
